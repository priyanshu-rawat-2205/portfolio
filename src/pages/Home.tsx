            ...
            <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
              <defs>
                <linearGradient id="blob-gradient" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#FF3D7F" className="dark:opacity-70" />
                  <stop offset="50%" stopColor="#FF9E9E" className="dark:opacity-70" />
                  <stop offset="100%" stopColor="#7F00FF" className="dark:opacity-70" />
                </linearGradient>
                <filter id="glow">
              ...
              <path
                ...
                filter="url(#glow)"
                className="opacity-80 dark:opacity-60 mix-blend-multiply dark:mix-blend-screen"
